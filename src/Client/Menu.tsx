          ...
          <div className="w-[100%] h-[90%] bg-white flex justify-around flex-col items-center">
            <div className="w-[100%] h-[70%] flex flex-col justify-around items-center">
              <div className="w-[100%] h-[14%] flex justify-center gap-1 items-center">
                <div className={`${ToggleSidebar ? "flex justify-start gap-2 items-center w-[70%] cursor-pointer" : "flex justify-start items-center cursor-pointer "} `} onClick={() => navigate('/user/over')}>
              ...
              <div className="w-[100%] h-[15%] flex justify-center gap-1 items-center">
                <div className={`${ToggleSidebar ? "flex justify-start gap-2 items-center w-[70%] cursor-pointer" : "flex justify-around items-center cursor-pointer"} `} onClick={() => navigate('/user/deposit')}>
                  <GoPlus className="text-2xl text-[#CCCCCC]" />
                  {ToggleSidebar && (<div className="text-xl">Deposit</div>)}
                </div>
              </div>
              <div className="w-[100%] h-[15%] flex justify-center gap-1 items-center">
                <div className={`${ToggleSidebar ? "flex justify-start gap-2 items-center w-[70%] cursor-pointer" : "flex justify-around items-center cursor-pointer"}`} onClick={() => navigate('/user/plans')}>
                  <LuWallet className="text-2xl text-[#CCCCCC]" />
                  {ToggleSidebar && (<div className="text-xl">My Plans</div>)}
                </div>
              </div>
              <div className="w-[100%] h-[15%] flex justify-center gap-1 items-center">
                <div className={`${ToggleSidebar ? "flex justify-start gap-2 items-center w-[70%] cursor-pointer" : "flex justify-around items-center cursor-pointer"}`} onClick={() => navigate('/user/withdraw')}>
                  <BiMoneyWithdraw className="text-2xl text-[#CCCCCC]" />
                  {ToggleSidebar && (<div className="text-xl">Withdraw</div>)}
                </div>
              </div>
              <div className="w-[100%] h-[15%] flex justify-center gap-1 items-center">
                <div className={`${ToggleSidebar ? "flex justify-start gap-2 items-center w-[70%] cursor-pointer" : "flex justify-around items-center cursor-pointer"}`} onClick={() => navigate('/user/history')}>
            ...
            <div className="w-[100%] h-[20%]">
              <div className="w-[100%] h-[100%] flex justify-center items-center">
                <div className={`${ToggleSidebar ? "flex justify-start gap-2 items-center w-[70%] cursor-pointer" : "flex justify-center items-center cursor-pointer"}`} onClick={() => navigate('/logout')}>
